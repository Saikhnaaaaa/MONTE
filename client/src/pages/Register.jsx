...
const Register = () => {
  ...
  return (
    <section className=" w-full container mx-auto px-2 flex items-center justify-center  ">
      <div className="bg-white w-full p-7 rounded-md my-4 max-w-lg mx-auto">
        <p>Monte mebel-д тавтай морил</p>

        <form className="grid gap-4 mt-6 " onSubmit={handeSubmit}>
          {/* name  */}
          ...
          <div className="grid gap-1">
            ...
            <div className="bg-blue-50 p-2 border rounded flex items-center justify-between focus-within:border-primary-200">
              <input
                type={showConPass ? "text" : "confirmPassword"}
                id="confirmPassword"
                className="outline-none w-full"
