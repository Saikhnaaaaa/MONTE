...
const EditProductAdmin = ({ data, close, fetchProductData }) => {
  ...
  return (
    <section className="fixed top-0 right-0 left-0 bottom-0 bg-black bg-opacity-70 p-4 z-50 flex justify-center items-center">
      <div className="bg-white w-full p-4 max-w-2xl mx-auto rounded +h-full max-h-[90vh] overflow-y-auto">
        <section>
          ...
          <div className="grid gap-2 p-8 bg-blue-300 rounded-lg ">
            <form className="grid gap-3" onSubmit={handleSubmit}>
              ...
              {Object?.keys(uploadProductData?.more_details)?.map(
                (key, index) => {
                  return (
